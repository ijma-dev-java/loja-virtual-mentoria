...
public class ConsultaCnpjDTO implements Serializable {
	...
	private SimplesSimeiDTO simples;

	private SimplesSimeiDTO simei;
	...
	public SimplesSimeiDTO getSimples() {
		return simples;
	}

	public void setSimples(SimplesSimeiDTO simples) {
		this.simples = simples;
	}

	public SimplesSimeiDTO getSimei() {
		return simei;
	}

	public void setSimei(SimplesSimeiDTO simei) {
		this.simei = simei;
	}
